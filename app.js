...
function App() {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    })), !v.isCompleted && /*#__PURE__*/React.createElement("button", {
      onClick: function (e) { e.stopPropagation(); setDepositAmount(''); setQuickAddGoalId(g.id); },
      style: css('display:flex;align-items:center;justify-content:center;gap:6px;width:100%;margin-top:12px;background:#eef6ff;color:#0071e3;border:none;border-radius:10px;padding:10px;font-size:13px;font-weight:700;cursor:pointer;')
    }, /*#__PURE__*/React.createElement("span", { style: css('font-size:17px;line-height:1;') }, "+"), s.language === 'es' ? 'Agregar ahorro' : 'Add savings'), !v.isCompleted && totalPart > 0 && /*#__PURE__*/React.createElement("div", {
